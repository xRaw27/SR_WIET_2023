...
{
    default String bulbul()
        throws BulbulatorIsJammed
    {
        return bulbul(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String bulbul(java.util.Map<String, String> context)
        throws BulbulatorIsJammed
    {
        try
        {
            return _iceI_bulbulAsync(context, true).waitForResponseOrUserEx();
        }
        catch(BulbulatorIsJammed ex)
        {
            throw ex;
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.String> bulbulAsync()
    {
        return _iceI_bulbulAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> bulbulAsync(java.util.Map<String, String> context)
    {
        return _iceI_bulbulAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_bulbulAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "bulbul", null, sync, _iceE_bulbul);
    ...
    /** @hidden */
    static final Class<?>[] _iceE_bulbul =
    {
        BulbulatorIsJammed.class
    };
