...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default long avg(long[] numbers)
    {
        return avg(numbers, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default long avg(long[] numbers, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(numbers, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Long> avgAsync(long[] numbers)
    {
        return _iceI_avgAsync(numbers, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Long> avgAsync(long[] numbers, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Long> _iceI_avgAsync(long[] iceP_numbers, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Long> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "avg", null, sync, null);
        f.invoke(true, context, null, ostr -> {
